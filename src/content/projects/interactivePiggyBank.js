...
export const interactivePiggyBankContent = {
  hero: {
    title: 'Interactive Piggy Bank',
    image: heroImage,
  },
  intro: {
    badge: 'Family Finance UX',
    heading: 'Designing a dual-interface app that turns money habits into family learning',
    paragraphs: [
      'Interactive Piggy Bank is a family-focused financial education app for children and their parents. The concept combines savings goals, spending awareness, and parental guidance in a shared system designed to make money conversations more approachable and more consistent at home.',
      'The project grew out of research into real family habits and evolved through wireframing, prototyping, testing, and iteration. The result is a product concept built around engagement, simplicity, and collaborative learning rather than one-way financial tracking.',
    ],
  ...
  overview: {
    eyebrow: 'Overview',
    heading: 'A playful app built around real financial behavior',
    paragraphs: [
      'The project aimed to help children build smart money habits while also giving parents practical ways to guide and support that learning. Instead of treating finance as a purely adult-oriented dashboard problem, the design framed it as a shared educational experience.',
      'The app concept centered on dual interfaces, goal-oriented saving, spending visibility, and conversation-based learning. Research, testing, and iteration all pushed the product toward clarity, encouragement, and family participation.',
    ],
    principles: [
      {
  ...
  designWalkthroughLabel: 'Design Walkthrough',
  processSteps: [
    {
      number: 1,
  ...
  challenges: {
    eyebrow: 'Challenges',
    heading: 'What made the project harder',
    paragraph:
      'The project moved through real constraints around time, tooling, and teamwork. Those challenges affected both pace and process, and they shaped how the team collaborated from research through refinement.',
    cards: [
      {
  ...
  reflection: {
    eyebrow: 'Reflection',
    heading: 'What this project taught me about design work',
    paragraphs: [
      'This was one of my earliest opportunities to work through a full design cycle with another person, from problem framing and research to prototypes, testing, and revision. That made the project especially valuable because it exposed how much product quality depends on collaboration, communication, and iteration rather than only visual execution.',
      'A major takeaway was learning how complementary strengths can improve a project when the team is willing to discuss and negotiate ideas thoughtfully. My teammate’s research and synthesis skills balanced my visual design focus, and working through those differences helped create a stronger final direction.',
      'The tight schedule also sharpened my time management and prioritization skills. The project reinforced that user-centered design is rarely linear: it is a process of listening, simplifying, testing, and refining until the product supports the people it is meant to help.',
    ],
    image: reflectionImage,
    imageAlt: 'Interactive Piggy Bank concluding reflection visual',
  },
};

export default interactivePiggyBankContent;
